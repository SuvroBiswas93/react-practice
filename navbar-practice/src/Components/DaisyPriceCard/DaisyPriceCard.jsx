 ...
 const{title,price,features,popular}=pricing
  ...
  <div className="card-body">
    ...
    <ul className="mt-6 flex flex-col flex-1 gap-2 text-xs">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success  flex-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
        <span>{feature}</span>
      </li>)
        }
